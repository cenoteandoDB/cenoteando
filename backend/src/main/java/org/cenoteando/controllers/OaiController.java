...
public class OaiController {
    ...
    void configure() throws ConfigurationException, InvalidContextException, IOException {
        ...
        FormatConfiguration formatConfiguration = new FormatConfiguration("oai_datacite")
                ...
                .withSchemaLocation("http://schema.datacite.org/oai/oai-1.1 http://schema.datacite.org/oai/oai-1.1/oai.xsd");
        ContextConfiguration contextConfiguration = new ContextConfiguration(identify.getBaseUrl())
        ...
        _dataProvider = new OAIDataProvider(
                manager,
                identify.getBaseUrl(),
                identify,
                setRepository,
    ...
    @EventListener
    public void onApplicationEvent(ContextRefreshedEvent event) throws ConfigurationException, InvalidContextException, IOException {
