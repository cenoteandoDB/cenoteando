...
public class CenoteandoAtLeastOneMetadataFilter extends CenoteandoFilter {
    ...
    private CenoteandoMetadataFilterOperator operator = CenoteandoMetadataFilterOperator.UNDEF;
    ...
    private CenoteandoMetadataFilterOperator getOperator() {
        if (operator == CenoteandoMetadataFilterOperator.UNDEF)
            operator = CenoteandoMetadataFilterOperator.valueOf(getConfiguration()
