...
public class CommentBucket {
    ...
    public enum CommentSource {GOOGLE_PLACES, TRIPADVISOR};
    ...
    public CommentBucket(String cenoteId, CommentSource source, int count, List<Comment> comments) {
        ...
        for(Comment comment : comments)
            this.sumRating += comment.getRating();
    }
