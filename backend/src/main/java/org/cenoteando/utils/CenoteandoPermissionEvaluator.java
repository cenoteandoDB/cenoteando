...
public class CenoteandoPermissionEvaluator implements PermissionEvaluator {
    ...
    @Override
    public boolean hasPermission(Authentication authentication, Object targetDomainObject, Object permissionEval) {
        ...
        if(targetDomainObject instanceof String){
            ...
            switch (permission){
                ...
                case "CENOTE.DELETE":
                    ...
                    if(user.getRole() == RESEARCHER || user.getRole() == CENOTERO_ADVANCED) {
                ...
                case "VARIABLE.UPDATE":
                    ...
                    switch (user.getRole()){
                        case ADMIN:
                        case RESEARCHER:
                            return variable.getAccessLevel() != SENSITIVE || variable.isCreator(user);
