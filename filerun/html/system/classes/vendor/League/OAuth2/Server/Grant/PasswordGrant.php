...
class PasswordGrant extends AbstractGrant
{
    ...
    public function completeFlow()
    {
        ...
        $userId = call_user_func($this->getVerifyCredentialsCallback(), $username, $password, $client);
	    ...
	    $accessToken->setDeviceUUID($this->server->getRequest()->request->get('device_uuid'));
        ...
        $this->server->getTokenType()->setParam('access_token', $accessToken->getToken());
        ...
        if ($this->server->hasGrantType('refresh_token')) {
	        ...
	        $refreshToken->setDeviceUUID($this->server->getRequest()->request->get('device_uuid'));
            $refreshToken->setExpireTime($this->server->getGrantType('refresh_token')->getRefreshTokenTTL() + time());
            $this->server->getTokenType()->setParam('refresh_token', $refreshToken->getToken());
        }
